	var PoiRadar = {
        ...
        $('#screen').on('click', addAirnote);
        $('#close').on('click', closeAirnote);
        $('#add').on('click', closeAirnote);

        var addAirnote = function()
        {
            $('#addAirnote').css("display", "block");
        };

        var closeAirnote = function()
        {
            $('#addAirnote').css("display", "none");
        };